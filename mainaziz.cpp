...
mainaziz::mainaziz(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::mainaziz)
{
    ui->setupUi(this);
    ...
    if (myarduino.getserial()->isOpen()) {
       ...
       connect(ui->ADD, &QPushButton::clicked, this, &mainaziz::on_ADD_clicked);
       connect(ui->upd, &QPushButton::clicked, this, &mainaziz::on_upd_clicked);
       connect(ui->dlet, &QPushButton::clicked, this, &mainaziz::on_dlet_clicked);


       connect(ui->display, &QPushButton::clicked, this, &mainaziz::on_display_clicked);
       connect(ui->display_2, &QPushButton::clicked, this, &mainaziz::on_display_2_clicked);

       connect(ui->pdf, &QPushButton::clicked, this, &mainaziz::on_Pdf_Clicked);
       connect(ui->serch, &QPushButton::clicked, this, &mainaziz::on_serch_clicked);

       connect(ui->change, &QPushButton::clicked, this, &mainaziz::on_change_clicked);
       connect(ui->ser, &QPushButton::clicked, this, &::mainaziz::on_ser_Clicked);
       connect(ui->ExportToExcel, &QPushButton::clicked, this, &::mainaziz::on_ExportToExcel_Clicked);
       connect(ui->sortByDateEntree, &QPushButton::clicked, this, &mainaziz::on_sortByDateEntree_clicked);
       connect(ui->stat, &QPushButton::clicked, this, &mainaziz::on_stat_clicked);

       connect(ui->pic, &QPushButton::clicked, this, &mainaziz::on_pic_clicked);

       connect(ui->addtsk_2, &QPushButton::clicked, this, &::mainaziz::on_addtask_clicked);

      connect(ui->pushButton_5, &QPushButton::clicked, this, &mainaziz:: on_pushButton_5_clicked);
      connect(ui->dis, &QPushButton::clicked, this, &mainaziz::on_dis_clicked);

      setupTableView();
       connect(ui->pic_2, &QPushButton::clicked, this, &::mainaziz::on_pic_2_clicked);
       connect(ui->disimage, &QPushButton::clicked, this, &::mainaziz::on_disimage_clicked);

       connect(ui->delettask, &QPushButton::clicked, this, &::mainaziz::on_delettask_clicked);

       connect(ui->suggestPhoto, &QPushButton::clicked, this, &::mainaziz:: on_suggestPhoto_clicked);
       connect(ui->sortByDateEntree_2, &QPushButton::clicked, this, &::mainaziz::on_sortByDateEntree_2_clicked);
       connect(ui->tableView_5, &QTableView::clicked, this, &mainaziz::on_tableView_5_clicked);
      // connect(ui->updateButton, &QPushButton::clicked, this, &mainaziz::on_updateButton_clicked);

        connect(ui->ard, &QPushButton::clicked, this, &::mainaziz:: on_ard_clicked);
        connect(ui->tableView_3, &QTableView::clicked, this, &::mainaziz::on_tableView_3_clicked);
        connect(ui->onButton, &QPushButton::clicked, this, &mainaziz::on_onButton_clicked);
        connect(ui->offButton, &QPushButton::clicked, this, &mainaziz::on_offButton_clicked);

        connect(ui->submitButton, &QPushButton::clicked, this, &::mainaziz::on_submitButton_clicked);
...
void mainaziz::loadServicesToTableView() {
...
void mainaziz::on_tableView_3_clicked(const QModelIndex &index) {
...
void mainaziz::setupProgressPage()
{
...
// Inside your mainaziz class
arduino myarduino;  // Make sure this is defined as a member of mainaziz
void mainaziz::connectarduino() {
    if (!myarduino.getserial()->isOpen()) {
...
void mainaziz::on_onButton_clicked() {
...
void mainaziz::on_offButton_clicked() {
...
void mainaziz::incrementTapisValue() {
...
void mainaziz::addIncrementedTapisValue() {
    QSqlQuery query;
...
void mainaziz::on_submitButton_clicked() {
    QSqlQuery query;
...
*/
void mainaziz::ensureSerialPortOpen() {
    if (serial->isOpen()) {
...
//********************************************************************************************************************************arduino*************************************************************//
void mainaziz::on_ser_Clicked(){
    ui->stackedWidget->setCurrentIndex(0);
}
void mainaziz::on_display_clicked() {
    service E;
    ui->tableView->setModel(E.afficher());
}
void mainaziz::on_display_2_clicked() {
    service E;
    ui->tableView_4->setModel(E.afficher());
}
void mainaziz::on_ADD_clicked()
{
...
void mainaziz::on_change_clicked(){
...
void mainaziz::on_serch_clicked() {
...
void mainaziz::on_ExportToExcel_Clicked() {
    service s;
...
void mainaziz::setupStatisticsPage()
{
    qDebug() << "Setting up statistics page";
...
void mainaziz::on_pic_clicked(){
    ui->stackedWidget->setCurrentIndex(4);
}
void mainaziz::on_pushButton_5_clicked(){
...
/*
void mainaziz::populateServiceComboBox() {
...
*/
void mainaziz::on_addtask_clicked() {
...
void mainaziz::on_tableView_5_clicked(const QModelIndex &index) {
...
void mainaziz::on_updateButton_clicked() {
...
void mainaziz::on_delettask_clicked()
{
    // Get the selected index from the table view
...
void mainaziz::on_pic_2_clicked()
{
...
void mainaziz::on_disimage_clicked()
{
    QString id_service = ui->lineEdit_5->text();
       if (id_service.isEmpty()) {
...
void mainaziz::displayImageInTable(const QPixmap &pixmap)
{
...
void mainaziz::on_suggestPhoto_clicked() {
